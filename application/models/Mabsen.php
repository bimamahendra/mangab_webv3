...
class Mabsen extends CI_Model {
  ...
  public function getAllAbsen(){
    $query = $this->db->query("SELECT absen.ID_ABSEN, dosen.NAMA_DOSEN, matakuliah.NAMA_MATKUL, pertemuan.KELAS_PRTMN, absen.TOPIK_ABSEN, absen.METODE_ABSEN, absen.TS_ABSEN, absen.STATUS_ABSEN FROM absen
    ...
    JOIN dosen ON dosen.NIP_DOSEN = absen.NIP_DOSEN WHERE absen.STATUS_ABSEN = 1 ORDER BY (absen.TS_ABSEN) DESC");
    return $query->result();
  }
